        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Center(
                child: TextBold(
                    text: 'Booking Details', fontSize: 18, color: Colors.black),
              ),
              const SizedBox(
                height: 10,
              ),
              ...
              TextRegular(
                  text: 'Name: $driverName', fontSize: 14, color: Colors.black),
              const SizedBox(
                height: 5,
              ),
              TextRegular(
              ...
              ListTile(
                leading: TextRegular(
                    text: 'Estimated Fare', fontSize: 14, color: Colors.black),
                trailing: TextBold(
